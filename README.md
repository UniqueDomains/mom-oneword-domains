# Available .MOM One-Word Domains (8,644)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C642%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-8%2C644%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **8,644 domains** on the canonical page below.

**Public extract:** 8,642 rows · **Live catalog:** 8,644 domains
...
| alpha.mom      | premium   | $2,500    | $2,500        | 90             | 54     | 5      | name.com                           |
...
| ----------------------- | ------------------------------------------------ |
| 8,642-row public sample | 8,644 live domains                               |
...
> Unique Domains. *Available .MOM One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
