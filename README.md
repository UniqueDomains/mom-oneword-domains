# Available .MOM One-Word Domains (5,622,487)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C642%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C487%20domains-6f42c1">
...
> **Important:** this repository is a **public 8,642-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,487 domains** on the canonical page below.

**Public extract:** 8,642 rows · **Live catalog:** 5,622,487 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/mom?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_mom_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/mom?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_mom_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./mom.csv">CSV</a> / <a href="./mom.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_mom_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_mom_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .MOM search](https://unique.domains/domains/tld/mom?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_mom_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .MOM search](https://unique.domains/domains/tld/mom?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_mom_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./mom.csv) or [Download JSON](./mom.json)
...
- `mom.csv` — public CSV extract (8,642 rows)
- `mom.json` — public JSON extract (8,642 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,642-row public sample | 5,622,487 live domains                           |
...
| disney.mom     | resell    | —         | —             | 82             | 76     | 6      | 1API GmbH                          |
| power.mom      | premium   | $845      | $845          | 98             | 64     | 5      | namecheap                          |
| unity.mom      | available | $1.99     | $51.99        | 70             | 41     | 5      | name.com                           |
| own.mom        | resell    | —         | —             | 122            | 70     | 3      | Dynadot LLC                        |
| ant.mom        | premium   | $920,000  | $920,000      | 86             | 60     | 3      | West263 International Limited      |
| eternal.mom    | available | $1.99     | $51.99        | 92             | 40     | 7      | name.com                           |
...
| unify.mom      | available | $1.99     | $51.99        | 72             | 38     | 5      | name.com                           |
| state.mom      | resell    | —         | —             | 90             | 60     | 5      | Namecheap                          |
...
> Unique Domains. *Available .MOM One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
